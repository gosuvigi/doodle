...
VALUES ('Monday Indoor', 'VUB Indoor', 1, 'gosuvigi', '<h2>please</h2> come <b>${matchDate} before 20:50</b></br>Link to doodle: ${doodleLink}');
INSERT INTO doodle_templates (name, location, match_day_of_week, initiator, email_text)
VALUES ('Tuesday Outdoor', 'VUB Outdoor', 2, 'gosuvigi', '<h1>HODOR</h1> says <h2>${matchDate} Hodor</h2></br>Link to doodle: ${doodleLink}');
