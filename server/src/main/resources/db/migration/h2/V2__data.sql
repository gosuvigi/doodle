...
VALUES ('Monday Indoor', 'VUB Indoor', SYSTIMESTAMP, 'gosuvigi', '<h2>please</h2> come <b>${doodleDate} before 20:50</b></br>Link to doodle: ${doodleLink}');
INSERT INTO doodle_templates (name, location, match_date, initiator, email_text)
VALUES ('Tuesday Outdoor', 'VUB Outdoor', SYSTIMESTAMP, 'gosuvigi', '<h1>HODOR</h1> says <h2>${doodleDate} Hodor</h2></br>Link to doodle: ${doodleLink}');
